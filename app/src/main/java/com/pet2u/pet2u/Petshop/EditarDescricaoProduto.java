...
public class EditarDescricaoProduto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_descricao_produto);
    ...
    private void alert(String msg){
        Toast.makeText(EditarDescricaoProduto.this, msg, Toast.LENGTH_SHORT).show();
    }
