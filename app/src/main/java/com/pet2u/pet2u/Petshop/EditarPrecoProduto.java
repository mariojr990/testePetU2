...
public class EditarPrecoProduto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_preco_produto);
    ...
    private void alert(String msg){
        Toast.makeText(EditarPrecoProduto.this, msg, Toast.LENGTH_SHORT).show();
    }
