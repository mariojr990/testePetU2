...
public class EditarNomeProduto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_nome_produto);
    ...
    private void alert(String msg){
        Toast.makeText(EditarNomeProduto.this, msg, Toast.LENGTH_SHORT).show();
    }
